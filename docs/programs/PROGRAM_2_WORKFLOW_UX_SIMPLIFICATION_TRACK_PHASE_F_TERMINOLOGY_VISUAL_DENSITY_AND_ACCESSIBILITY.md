...
Stepper, kartice konteksta i navigacija koriste semantičke `nav`, `details`, `summary`, `tablist`, `tab`, `tabpanel`, `aria-current`, `aria-selected` i vidljivi fokus. Statusi i problemi uvijek imaju tekst; boja nije jedini signal. Responsive prikaz slaže sadržaj na manjim laptopima i tabletima.
