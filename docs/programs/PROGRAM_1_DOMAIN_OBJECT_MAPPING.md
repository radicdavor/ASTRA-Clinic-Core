...
| Core route file remains oversized | Program 1 API surfaces | `core.py` i dalje sadrzi mijesane patient, document, summary, readiness i episode route odgovornosti. | Buduci rad moze slucajno mijesati semantike. | Core Route Modularization Pass |
