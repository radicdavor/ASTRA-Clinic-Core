...
| Human pilot | `docs/pilot_sessions/2026-07-05_human_pilot_01.md` | Pending - Deferred after V15 inspection | completed or explicitly waived | incomplete without waiver |
...
- Deferred: human pilot incomplete and not waived. This is the current V14 decision state.
