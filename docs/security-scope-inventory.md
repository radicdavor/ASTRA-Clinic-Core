...
| clinical-document list/search/detail/download/write/review/addendum | ClinicalDocument | institution clinical | exact document institution; unresolved and unclassified denied | canonical clinical-document access service; manual and database defaults are `unclassified` until human review | document operation permission | document provenance suites, `test_pr3_fourth_security_document_classification.py` | enforced |
