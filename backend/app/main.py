...
from app.api.routes import ai, appointments, auth, catalog, clinical_documents, core, episodes, inventory, patient_clinical_summary, patients, readiness, reception, system
