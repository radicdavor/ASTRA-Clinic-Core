...
from app.api.routes import ai, appointments, audit, auth, catalog, clinical_documents, episodes, intake, inventory, knowledge, laboratory, patient_clinical_summary, patient_journeys, patients, readiness, reception, search, system, therapies, workflow
