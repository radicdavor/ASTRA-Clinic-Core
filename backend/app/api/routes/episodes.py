...
from app.schemas.common import AppointmentOperationalOut, ClinicalDecisionTimelineItem, ClinicalEpisodeCreate, ClinicalEpisodeOut, ClinicalEpisodeUpdate, ClinicalPlanGenerate, ClinicalPlanOut, ClinicalPlanUpdate, ErrorResponse
...
@router.get("/episodes/{episode_id}/appointments", response_model=list[AppointmentOperationalOut])
