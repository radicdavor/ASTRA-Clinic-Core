...
export type AITodayOut = {
  appointments: Array<AppointmentOperationalOut>;
  date: string;
};
...
export type AppointmentOperationalOut = {
...
export type AppointmentReceptionOut = {
  ...
  identity_verified_at?: string | null;
  identity_verified_by?: number | null;
  patient?: PatientReceptionIdentityOut | null;
  patient_id: number;
  provider?: ProviderOperationalOut | null;
  provider_id: number;
  room?: RoomOperationalOut | null;
...
export type PatientOperationalIdentityOut = {
  date_of_birth?: string | null;
  first_name: string;
  id: number;
  last_name: string;
...
export type ProviderOperationalOut = {
  clinic_id?: number | null;
  full_name: string;
  id: number;
  specialty?: string | null;
...
export type ReceptionSlot = {
  appointment?: AppointmentReceptionOut | null;
  empty?: boolean;
  span?: number;
  time: string;
};
...
export type RoomOperationalOut = {
  clinic_id?: number | null;
  id: number;
  name: string;
  type?: string | null;
...
export type ServiceOperationalOut = {
  code?: string | null;
  duration_minutes: number;
  id: number;
  name: string;
