...
export type PatientJourneyDetail = {
  ...
  patient: { id: number; first_name: string; last_name: string; date_of_birth: string | null; oib: string | null; email: string | null; phone?: string | null; email_verified_at: string | null; updated_at: string };
  appointment: {
