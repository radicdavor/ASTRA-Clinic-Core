...
export type Therapy = {id:number;patient_id:number;episode_id?:number|null;parent_therapy_id?:number|null;name:string;instructions:string;start_date:string;end_date?:string|null;status:"active"|"completed"|"stopped";prescriber?:string|null;notes?:string|null;stopped_at?:string|null;stop_reason?:string|null;completed_at?:string|null;completion_note?:string|null;created_at:string;patient:Patient};
