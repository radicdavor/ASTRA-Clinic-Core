...
assertIncludes("src/pages/PatientDetail.tsx", "Nije dijagnoza");
...
assertIncludes("src/pages/PatientDetail.tsx", "Ne stvara Task, Outcome Evidence ili poruku pacijentu.");
assertIncludes("src/pages/PatientDetail.tsx", "To ne znaci da nema otvorenih klinickih pitanja.");
