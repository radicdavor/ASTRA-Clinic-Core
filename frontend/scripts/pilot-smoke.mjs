...
assertIncludes("src/pages/AppointmentDetail.tsx", "Snapshot nije spremljen. Provjerite dozvole ili pokusajte ponovno.");
...
assertNotIncludes("src/pages/AppointmentDetail.tsx", "Novi snapshot");
...
assertNotIncludes("src/api/client.ts", "supersedeClinicalReadinessSnapshot");
