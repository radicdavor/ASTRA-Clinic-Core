...
assertIncludes("src/pages/Reception.tsx", 'view === "week" ? -7 : -1');
assertIncludes("src/pages/Reception.tsx", 'view === "week" ? 7 : 1');
...
assertIncludes("src/pages/Reception.tsx", "getClinicToday");
...
assertIncludes("src/pages/AppointmentForm.tsx", "withinProviderHours");
...
assertIncludes("src/pages/AppointmentForm.tsx", "if (routeState?.backgroundLocation)");
