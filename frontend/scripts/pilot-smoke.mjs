...
assertIncludes("src/pages/AppointmentDetail.tsx", "Ovo je zapis ljudskog pregleda savjetodavnog signala. Nije klinicko odobrenje i ne mijenja status termina.");
assertIncludes("src/pages/AppointmentDetail.tsx", "Nema zapisa ljudskog pregleda za ovaj termin. To ne znaci da nema klinickih rizika.");
